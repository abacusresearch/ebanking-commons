...
@Log4j2
class AsyncResponseSaveHandlerImpl implements AsyncResponseSaveHandler{
  ...
  AsyncResponseSaveHandlerImpl(final StorageService storageService,
  ...
  private String getMessage(final Throwable th) {
