...
public class TransportDataUtilTest {
  ...
  void testGetKeyValuePairEncoded(){
    Assertions.assertEquals("b=Test%3Dabcd%21efg%24%C3%A4%21%C3%A8%26%25%C3%A7f", getKeyValuePair(BANK_ID, "Test=abcd!efg$ה!ט&%חf",true,true));
  }

  @Test
  void testGetElementDecode(){
    Assertions.assertEquals("Test=abcd!efg$ה!ט&%חf", getElement(BANK_ID_PATTERN, "b=Test%3Dabcd%21efg%24%C3%A4%21%C3%A8%26%25%C3%A7f",true));
  }
