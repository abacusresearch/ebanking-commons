...
public class SaxXmlBodyFilterTest {
  ...
  private static final String ENVELEOP_XML_DECLARATION = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\" ?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Header/><soapenv:Body><ns1:Logon1TanRequest xmlns:ns1=\"http://elink.zkb.ch/v3_0/xsd\"><sprachCode>DE</sprachCode><vertragnummer>700-1111</vertragnummer><passwort>123456</passwort><software>deeppay</software><version>1.0.0</version></ns1:Logon1TanRequest></soapenv:Body></soapenv:Envelope>";
  ...
  private static final String REF_ENVELEOP_XML_DECLARATION = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\"><soapenv:Header/><soapenv:Body><ns1:Logon1TanRequest xmlns:ns1=\"http://elink.zkb.ch/v3_0/xsd\"><sprachCode>DE</sprachCode><vertragnummer>[secret]</vertragnummer><passwort>[secret]</passwort><software>deeppay</software><version>1.0.0</version></ns1:Logon1TanRequest></soapenv:Body></soapenv:Envelope>";
  ...
  @Test
  void testFilterWithXmlDeclaration() {
    SaxXmlBodyFilter filter = new SaxXmlBodyFilter("[secret]", Sets.newHashSet("vertragnummer", "passwort"));
    Assertions.assertEquals(REF_ENVELEOP_XML_DECLARATION, filter.filter(MediaType.APPLICATION_XML_VALUE, ENVELEOP_XML_DECLARATION));
  }
